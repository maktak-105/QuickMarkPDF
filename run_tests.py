...
timing.
    ...
    python run_tests.py                        # default suite (unit + integration + visual + perf)
    python run_tests.py --real-screen           # also runs the real_screen tier (needs a live desktop)
    python run_tests.py --update-visual-baselines
    python run_tests.py -- tests/test_pdf_manager.py   # anything after `--` is passed straight to pytest
...
def _write_dashboard_html(summary: dict) -> Path:
    ...
    baselines_dir = REPO_ROOT / "tests" / "visual_baselines"
