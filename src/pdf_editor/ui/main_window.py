...
from PySide6.QtWidgets import (
    QMainWindow, QWidget, QHBoxLayout, QLabel, QScrollArea,
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.splitter.setSizes([164, 1000])
    ...
    def edit_header_footer(self):
        """Open simple header/footer settings and apply to all pages."""
        if self.pdf_manager.get_page_count() == 0:
            QMessageBox.information(self, "情報", "PDFを先に開いてください")
            return

        # Simple input for header title
        ...
        # Refresh thumbnails and preview
        self.thumbnail_panel.refresh()
        ...
        self.statusBar().showMessage("ヘッダー/フッターを追加しました（ページ番号 + タイトル）")
